                    ...
                    <form ng-submit="ctrl.addGame()" name="gameForm" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-2 control-lable text-light" for="gameNameInput">Name*</label>
                                <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="form-actions floatRight">
                                <input data-ng-if="!ctrl.game.id" type="submit" value="Add" class="btn btn-primary btn-sm"style="backround-color: blue">
                                <button data-ng-if="ctrl.game.id" type="button" data-ng-click="ctrl.updateGame()" class= "btn btn-secondary btn-sm"style="backround-color: blue" >Submit Update</button>
                                <button data-ng-if="ctrl.game" type="reset" data-ng-click="ctrl.clearForm()" class= "btn btn-secondary btn-sm"style="backround-color: blue" >Clear</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
                            <tr ng-repeat="currentGame in ctrl.games">
                                ...
                                <td><td>
                                <td><button data-ng-click="ctrl.loadGameToUpdate(currentGame)" class= "btn btn-secondary btn-sm" >Update</button>
